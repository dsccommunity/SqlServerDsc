...
Configuration Example
{
    ...
    node localhost
    {
        SqlAudit SecurityLogAudit_Server01
        {
            Ensure               = 'Present'
        ...
        SqlAudit SecurityLogAudit_Server02
        {
            Ensure               = 'Present'
            ServerName           = 'sqltest.company.local'
            InstanceName         = 'DSC'
        ...
        SqlServerAuditSpecification ServerAuditSpecification_AuditAudit
        {
            ...
            DependsOn            = '[SqlAudit]SecurityLogAudit_Server01'
            PsDscRunAsCredential = $SqlAdministratorCredential
        }
        ...
        SqlServerAuditSpecification ServerAuditSpecification_AdminAudit
        {
            ...
            TraceChangeGroup                    = $true
            DependsOn                           = '[SqlAudit]SecurityLogAudit_Server02'
            PsDscRunAsCredential                = $SqlAdministratorCredential
        }
    }
}
