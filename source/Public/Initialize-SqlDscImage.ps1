<#
    .SYNOPSIS
        Prepares a SQL Server instance for image-based deployment.

    .DESCRIPTION
        Prepares a SQL Server instance for image-based deployment (sysprep).
        After preparation, use `Complete-SqlDscImage` to complete the installation.
    ...
    .EXAMPLE
        Initialize-SqlDscImage -AcceptLicensingTerms -Features 'SQLENGINE' -InstanceId 'MyInstance' -MediaPath 'E:\'
...
#>
function Initialize-SqlDscImage
{
    ...
    Invoke-SetupAction -PrepareImage @PSBoundParameters
}
