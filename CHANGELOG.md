...
- Changes to xSQLServerAlwaysOnAvailabilityGroup
  - change compatibility check for the feature BasicAvailabilityGroup which only applies on Standard Edition
  - change the check of the values entered as paramater for BasicAvailabilityGroup. It is a boolean, hence it was not possible to disable the disable
