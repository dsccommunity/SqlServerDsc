...
Configuration Example 
{
    ...
    node localhost {
        ...
        xSQLServerDatabasePermission Deny_SqlDatabasePermissions_SQLAdmin_Db01
        {
            Ensure = 'Present'
            Name = 'CONTOSO\SQLAdmin'
        ...
        xSQLServerDatabasePermission Deny_SqlDatabasePermissions_SQLUser_Db01
        {
            Ensure = 'Present'
            Name = 'CONTOSO\SQLUser'
            Database = 'AdventureWorks'
        ...
        xSQLServerDatabasePermission Deny_SqlDatabasePermissions_SQLAdmin_Db02
        {
            Ensure = 'Present'
            Name = 'CONTOSO\SQLAdmin'
