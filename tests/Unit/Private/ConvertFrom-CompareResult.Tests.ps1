    ...
    Context 'When passing as named parameter' {
        It 'Should return the correct values in a hashtable' {
            InModuleScope -ScriptBlock {
                ...
                $getDesiredStateForSplattingResult = ConvertFrom-CompareResult -CompareResult $mockProperties
    ...
    Context 'When passing in the pipeline' {
        It 'Should return the correct values in a hashtable' {
            InModuleScope -ScriptBlock {
                ...
                $getDesiredStateForSplattingResult = $mockProperties | ConvertFrom-CompareResult
