...
Describe 'New-SqlDscRSEncryptionKey' {
    Context 'When validating parameter sets' {
        It 'Should have the correct parameters in parameter set <ExpectedParameterSetName>' -ForEach @(
            ...
            $result = (Get-Command -Name 'New-SqlDscRSEncryptionKey').ParameterSets |
    ...
    Context 'When creating new encryption key successfully' {
        BeforeAll {
    ...
    Context 'When creating new encryption key with PassThru' {
        BeforeAll {
            $mockCimInstance = [PSCustomObject] @{
                InstanceName = 'SSRS'
            }
    ...
    Context 'When creating new encryption key with Force' {
        BeforeAll {
            $mockCimInstance = [PSCustomObject] @{
                InstanceName = 'SSRS'
            }
