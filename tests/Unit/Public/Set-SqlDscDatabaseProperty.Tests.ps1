    ...
    Context 'Parameter validation' {
        ...
        It 'Should have the correct parameters in parameter set DatabaseObjectSet' -ForEach @(
            @{
                ...
                ExpectedParameters = '-DatabaseObject <Database> [-AcceleratedRecoveryEnabled] [-AnsiNullDefault] [-AnsiNullsEnabled] [-AnsiPaddingEnabled] [-AnsiWarningsEnabled] [-ArithmeticAbortEnabled] [-AutoClose] [-AutoCreateIncrementalStatisticsEnabled] [-AutoCreateStatisticsEnabled] [-AutoShrink] [-AutoUpdateStatisticsAsync] [-AutoUpdateStatisticsEnabled] [-BrokerEnabled] [-ChangeTrackingAutoCleanUp] [-ChangeTrackingEnabled] [-CloseCursorsOnCommitEnabled] [-ConcatenateNullYieldsNull] [-DatabaseOwnershipChaining] [-DataRetentionEnabled] [-DateCorrelationOptimization] [-EncryptionEnabled] [-HonorBrokerPriority] [-IsFullTextEnabled] [-IsParameterizationForced] [-IsReadCommittedSnapshotOn] [-IsSqlDw] [-IsVarDecimalStorageFormatEnabled] [-LegacyCardinalityEstimation <DatabaseScopedConfigurationOnOff>] [-LegacyCardinalityEstimationForSecondary <DatabaseScopedConfigurationOnOff>] [-LocalCursorsDefault] [-NestedTriggersEnabled] [-NumericRoundAbortEnabled] [-ParameterSniffing <DatabaseScopedConfigurationOnOff>] [-ParameterSniffingForSecondary <DatabaseScopedConfigurationOnOff>] [-QueryOptimizerHotfixes <DatabaseScopedConfigurationOnOff>] [-QueryOptimizerHotfixesForSecondary <DatabaseScopedConfigurationOnOff>] [-QuotedIdentifiersEnabled] [-ReadOnly] [-RecursiveTriggersEnabled] [-RemoteDataArchiveEnabled] [-RemoteDataArchiveUseFederatedServiceAccount] [-TemporalHistoryRetentionEnabled] [-TransformNoiseWords] [-Trustworthy] [-ChangeTrackingRetentionPeriod <int>] [-DefaultFullTextLanguage <int>] [-DefaultLanguage <int>] [-MaxDop <int>] [-MaxDopForSecondary <int>] [-MirroringRedoQueueMaxSize <int>] [-MirroringTimeout <int>] [-TargetRecoveryTime <int>] [-TwoDigitYearCutoff <int>] [-MaxSizeInBytes <double>] [-Collation <string>] [-FilestreamDirectoryName <string>] [-MirroringPartner <string>] [-MirroringPartnerInstance <string>] [-MirroringWitness <string>] [-PersistentVersionStoreFileGroup <string>] [-PrimaryFilePath <string>] [-RemoteDataArchiveCredential <string>] [-RemoteDataArchiveEndpoint <string>] [-RemoteDataArchiveLinkedServer <string>] [-RemoteDatabaseName <string>] [-ChangeTrackingRetentionPeriodUnits <RetentionPeriodUnits>] [-CompatibilityLevel <CompatibilityLevel>] [-ContainmentType <ContainmentType>] [-DelayedDurability <DelayedDurability>] [-FilestreamNonTransactedAccess <FilestreamNonTransactedAccessType>] [-MirroringSafetyLevel <MirroringSafetyLevel>] [-PageVerify <PageVerify>] [-RecoveryModel <RecoveryModel>] [-UserAccess <DatabaseUserAccess>] [-Force] [-PassThru] [-WhatIf] [-Confirm] [<CommonParameters>]'
            }
        ) {
            $result = (Get-Command -Name 'Set-SqlDscDatabaseProperty').ParameterSets |
                Where-Object -FilterScript { $_.Name -eq $ExpectedParameterSetName } |
