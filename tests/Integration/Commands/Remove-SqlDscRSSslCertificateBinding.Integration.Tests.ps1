...
BeforeAll {
    ...
    <#
        ...
        integration tests. This test removes the binding that was added by those tests.
    #>
...
<#
    .NOTES
        These tests remove the SSL certificate binding that was added by the
        Add-SqlDscRSSslCertificateBinding integration tests. The binding is
