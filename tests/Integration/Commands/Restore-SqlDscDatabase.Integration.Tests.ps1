...
Describe 'Restore-SqlDscDatabase' -Tag @('Integration_SQL2017', 'Integration_SQL2019', 'Integration_SQL2022', 'Integration_SQL2025') {
    BeforeAll {
    ...
    Context 'When performing a restore with NoRecovery' {
        ...
        It 'Should restore database in restoring state with NoRecovery' {
            ...
            $restoredDb | Should-BeTruthy
            $restoredDb.Status | Should-MatchString 'Restoring'
        }
    }
