...
Describe "$($script:dscResourceName)_Integration" -Tag @('Integration_SQL2016', 'Integration_SQL2017', 'Integration_SQL2019', 'Integration_SQL2022') {
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_AddDatabase1_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_AddDatabase2_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_AddDatabase3_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_AddDatabase4_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_AddDatabase5_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_RemoveDatabases_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
