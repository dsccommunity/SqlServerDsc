...
Describe "$($script:dscResourceName)_Integration" -Tag @('Integration_SQL2016', 'Integration_SQL2017', 'Integration_SQL2019', 'Integration_SQL2022') {
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_AddSecLogAudit_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_RemoveAudit1_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.ServerName | Should-Be $ConfigurationData.AllNodes.ServerName
            $resourceCurrentState.InstanceName | Should-Be $ConfigurationData.AllNodes.InstanceName
            $resourceCurrentState.Path | Should-BeFalsy
            $resourceCurrentState.MaximumFileSize | Should-BeFalsy
            $resourceCurrentState.MaximumFileSizeUnit | Should-BeFalsy
    ...
    Context ('When using configuration <_>') -ForEach @(
        "$($script:dscResourceName)_RemoveSecLogAudit_Config"
    ) {
        BeforeAll {
            $configurationName = $_
        }
        ...
        It 'Should have set the resource and all the parameters should match' {
            ...
            $resourceCurrentState.ServerName | Should-Be $ConfigurationData.AllNodes.ServerName
            $resourceCurrentState.InstanceName | Should-Be $ConfigurationData.AllNodes.InstanceName
            $resourceCurrentState.LogType | Should-BeFalsy
            $resourceCurrentState.AuditFilter | Should-BeFalsy
        }
