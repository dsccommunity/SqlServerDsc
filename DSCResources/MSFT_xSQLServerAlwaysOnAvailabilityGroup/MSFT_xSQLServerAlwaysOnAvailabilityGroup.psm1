    ...
    switch ($Ensure)
    {
        ...
        Present
        {
            ...
            if ( -not $availabilityGroup )
            {
                ...
                {
                    throw New-TerminatingError -ErrorType CreateAvailabilityGroupReplicaFailed -FormatArgs $Ensure,$SQLInstanceName -ErrorCategory OperationStopped -InnerException $_.Exception
                }
